...
const contact_detail = [
  ...
  },
  {
    title: "Email",
    icon: <RiMailLine />,
    info: "contact@expertconnect.com"
  },
]
    ...
    <footer className='footer'>
      <div className="footer-grid">
        <div className="footer__logo-section">
          ...
          <img src={logo} alt="ExpertConnect Logo" />
          <p>Your premier platform for booking 1-on-1 sessions with industry experts.</p>
      ...
      <div className='footer__copyright'>
        <p className="copyright">Copyright {year}, design and develop by Sakshi Maulekhi. All rights reserved</p>
      </div>
    </footer>
  )
}
